...
//  Navigation
//
//  Created by OksanaS on 11.04.2022.
//
...
class PostView: UIView {
    ...
    private func setupConstraints() {
        ...
        let topBackButtonConstraint = self.backButton.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor)
        let trailingBackButtonConstraint = self.backButton.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -16)
        let heightBackButtonConstraint = self.backButton.heightAnchor.constraint(equalToConstant: 30)
        let widthBackButtonConstraint = self.backButton.widthAnchor.constraint(equalToConstant: 30)
        ...
        NSLayoutConstraint.activate([ topConstraintAuthorLabel,
                                      ...
                                      topBackButtonConstraint, trailingBackButtonConstraint,
                                      heightBackButtonConstraint, widthBackButtonConstraint, leadingConstraintBackView, trailingConstraintBackView, centerXConstraintBackView, centerYConstraintBackView
